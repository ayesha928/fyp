...
def main(argv=sys.argv):
    ...
    if has_records < 1:
        with transaction.manager:
            devices = [[1, 'Door Lights', 1],
                       [2, 'Dining Energy savers', 2],
                       [3, 'Dining Fan', 2],
                       [4, 'TV lounge Tube Light', 3],
                       [5, 'Living rooms lamp', 4],
                       [6, 'Washrooms energy saver', 4],
                       [7, 'Kitchen fan', 5]]
