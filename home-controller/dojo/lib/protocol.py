...
def decode_command(input_byte):  # return a dictionary
    ...
    section_number = byte_binary_sequence[2:5]  # 3rd, 4th, 5th bits of Byte
    device_number = byte_binary_sequence[5:]  # last 3 bits of Byte
    ...
    my_dict = dict(command_type=command_type, status=status,
                   section_number=dec_section_number,
                   device_number=dec_device_number)  # dictionary
