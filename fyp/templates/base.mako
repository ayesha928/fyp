...
<h1><a href="#"></a> </h1>
  ...
  <p>&nbsp;</p>
    ...
    <div class="CollapsiblePanelContent">
      ...
      <div id="apDiv12"><a href="${request.route_url('security')}"><strong>SECURITY</strong></a></div>
      <p>&nbsp;</p>
      <div id="apDiv11"><a href="${request.route_url('status')}"><strong>STATUS</strong></a></div>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
  ...
  <div id="page">
    <div id="content">
      <div class="post">
        ...
        <div id="apDiv4">
          <p align="center"><img src="${request.static_url('fyp:static/images/settings77.PNG')}" alt="" width="77" height="80" /></p>
        </div>
        <div id="apDiv5">
          <div align="center">
            <p><img src="${request.static_url('fyp:static/images/status.PNG')}" alt="" width="86" height="92" /></p>
</div>
        </div>
<!-- end footer --></div>
</div>
